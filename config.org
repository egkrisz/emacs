...
(use-package emacs
  ...
  (if (> (display-pixel-width) 1024)
      (progn
        (set-face-attribute 'default nil :font (concat apex/def-font "-" apex/def-font-size))
        (set-face-attribute 'fixed-pitch nil :font (concat apex/def-font "-" apex/def-font-size))
        (set-face-attribute 'variable-pitch nil :font (concat apex/def-font "-" apex/def-font-size)))
    (progn
...
** Theme
#+BEGIN_SRC emacs-lisp
(defvar apex/dark-theme 'doom-one)
(defvar apex/light-theme 'doom-one-light)
