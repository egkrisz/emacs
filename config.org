    ...
    #+begin_src emacs-lisp
      (use-package eyebrowse
          :bind (:map override-global-map
                      ...
                      ("C-c C-w q" . #'eyebrowse-prev-window-config)
                      ("C-c C-w e" . #'eyebrowse-next-window-config))
        :config
...
(use-package org
  ...
  (setq org-default-notes-file "~/.eamcs.d/notes/todo.org")
  (setq org-agenda-files (list "~/.emacs.d/notes/todo.org"))
