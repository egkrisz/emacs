...
** Manupulate font size
   + Increase and decrease defaut font size with functions.
#+BEGIN_SRC emacs-lisp
(use-package emacs
  :straight nil
  :config
...
(use-package general
    ...
    (general-create-definer progtools-def
        :states '(normal visual emacs)
        :prefix "í"
        :non-normal-prefix "C-í"))
 #+END_SRC
** Evil
...
(use-package lsp-mode
  ...
  (progtools-def
    :keymaps 'prog-mode-map
        ...
        "ff" '(xref-find-definitions :wk "find definition")
        "fF" '(xref-find-definitions-other-window :wk "find definition other win")
        "fr" '(xref-find-references :wh "find references")
         "r" '(lsp-restart :wk "restart")))
...
(use-package auto-insert-mode
  ...
  (progtools-def
    :keymaps '(c++-mode-map 
                 c-mode-map)
    "<tab>" '(auto-insert :wk "Add header guards"))
  :init
...
Python IDE with =elpy= and =company=.
#+BEGIN_SRC emacs-lisp
(use-package elpy
  :init
